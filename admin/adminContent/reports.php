...
<!-- Export/Print Modal -->
<div class="modal fade" id="documentExportModal" tabindex="-1" aria-labelledby="documentExportModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-brand text-white">
        <h5 class="modal-title" id="documentExportModalLabel">Select Document Type</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <label for="documentTypeSelect" class="form-label fw-semibold">Choose Document Type:</label>
        <select id="documentTypeSelect" class="form-select">
          <option selected>First Time Job Seeker</option>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="confirmExportBtn" class="btn btn-success btn-sm">Proceed</button>
      </div>
    </div>
  </div>
</div>
...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    // 🧩 MODAL INTEGRATION FOR BARANGAY SERVICES EXPORT/PRINT
    let exportAction = "";
