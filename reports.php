                ...
                <div class="filterCard card m-1 p-3 d-none d-md-block">
                    <div class="row">
                        <div class="col d-flex flex-column align-items-center">
                            <a href="?page=complaintSection" class="btn btn-primary filterButton m-2 w-100 <?php echo ($page == 'complaintSection') ? 'active' : ''; ?>">Home</a>
                            <a href="?page=makeComplaint" class="btn btn-primary filterButton m-2 w-100 <?php echo ($page == 'makeComplaint') ? 'active' : ''; ?>">File a Complaint</a>
                            <a href="?page=submittedComplaints" class="btn btn-primary filterButton m-2 w-100 <?php echo ($page == 'submittedComplaints') ? 'active' : ''; ?>">Submitted Reports</a>
                        </div>
                    </div>
                </div>
