        ...
        <div class="row">
                ...
                <div class="filterCard card m-1 p-2 d-none d-sm-block">
                    ...
                    <div class="row mt-4">
                        <div class="col d-flex flex-column justify-content-center">
                            <button class="btn btn-primary filterButton m-2">All Documents</button>
                            <button class="btn btn-primary filterButton m-2">Barangay Hall</button>
                            <button class="btn btn-primary filterButton m-2">Migrant Information Office</button>
                            <button class="btn btn-primary filterButton m-2">Barangay Health</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-9 p-0">
                <div class="contentCard card m-1 p-2">
                    <div class="row m-auto" id="scrollable" style="max-height: 100vh; overflow-y: auto;">

                        <div class="col-6 col-md-4 col-lg-4 p-1">
                            <div class="documentCard card">
                                <img src="assets/images/announcements/image.png" class="card-img-top" style="width: 100%; height: 500px; object-fit: cover;" alt="...">
                                <div class="mt-auto d-flex">
                                    <button class="btn btn-primary contentButton mt-2">Barangay Certificate</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4 col-lg-4 p-1">
