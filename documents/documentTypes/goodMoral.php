<div class="col" style="color: black;">
    ...
    <div class="row">
        <div class="col">
            <p style="text-indent: 48px; text-align: justify;">This further certifies that the above-mentioned name has no <strong><?php echo $remarks ?></strong> on file and possess good moral character.</p>
        </div>
    </div>
    <div class="row">
        <div class="col">
